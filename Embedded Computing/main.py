...
def BP_callback (pin):
    ...
    if BP_press_flag == True:
        ...
        if Affiche_ecran_1_flag == True:
            ...
            tft.clear()
            Affichage_Graphique.tableau_ecran_2(capteur_BME280.read_temp(), capteur_BME280.read_humidity(), sgp40_capteur_cov.measure_index(capteur_BME280.read_temp(), capteur_BME280.read_humidity()), capteur_SCD41.CO2)
            Time_Out_screen2.init(period = 15, mode = Timer.ONE_SHOT, callback = TimeOut_Ctrl_affichage_ecran_2)
